...
class Armor:
    ...
    def _gen_seed(self, lower: int, upper: int) -> int:
        ...
        item_stat = (self.level * self.item_modifier[self.condition])
    ...
    def armor_chr(self):
        ...
        # you can use self.__dict__ to get all attributes of the class
        arm = dict(
            name=self.name,
            level=self.level,
            armor=self.armor,
...
if __name__ == '__main__':
    armor = Armor('test1', 'excellent', armor_type='helmet')
    print(armor.armor_chr)
    print(armor.print_arm_chr)

    armor2 = Armor('test2', 'excellent', armor_type='jacket')
    print(armor2.armor_chr)
    print(armor2.print_arm_chr)

    armor3 = Armor('test3', 'excellent', armor_type='trousers')
